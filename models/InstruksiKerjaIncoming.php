 ...
 */
 class InstruksiKerjaIncoming extends InstruksiKerja
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'case_number', $this->case_number])
            ...
            ->andFilterWhere(['like', 'fee_code_rp', $this->fee_code_rp])
